...
import java.util.Date;  
 ...
 class fodloc extends JFrame implements ActionListener
{
         JFrame f1; 
      ...
      fodloc()
      {
           ...
           //Sc.setBackground(Color.red);   
            name = new Label ("     FOOD LEFT FOR HOW MANY PEOPLE   :-                               ");
            clas = new Label ("     CONTACT NUMBER                  :-                               ");
            BNO = new Label("                       SHARING IS CARING                      ");
            BNO.setBackground(Color.yellow); 
            space = new Label("                                                                      ");
      ...
      {
            RandomAccessFile ff = new RandomAccessFile("list_food.dat","rw");
                 ...
                 ff.close();
                 f1.setVisible(false);
                 JOptionPane.showMessageDialog(null,"SUCCESSFULLY UPDATED FOOD AVAILABLE LOCATION \n GREAT !! You are a Responsible Citizen ");
                     //new goto();
