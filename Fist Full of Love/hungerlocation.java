...
import java.applet.*;
import java.lang.*;
public class hungerlocation extends JFrame implements ActionListener{
    JFrame F;
    JPanel P;
    ...
    hungerlocation()
    {
        ...
        ImageIcon I = new ImageIcon("D:\\Fist Full of Love\\hungerlocation.jpeg");
        IL = new JLabel(I);
        P.add(IL);
    ...
    {
        hungerlocation Mes = new hungerlocation();
    }
